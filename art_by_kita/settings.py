...
BREVO_API_KEY = env('BREVO_API_KEY', default="dummy_value")


# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ['127.0.0.1', 'localhost', 'art-by-kita-ci-af8ba42cd883.herokuapp.com', 'https://artbykita.netlify.app']
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, "frontend", "dist"),  # Adjust for Vite's output
]
